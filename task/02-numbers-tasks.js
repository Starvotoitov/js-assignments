...
function roundToPowerOfTen(num, pow) {
    let SpecifPow = Math.pow(10, pow);
    let RoundedPart = num % SpecifPow;
    return RoundedPart >= (SpecifPow / 2) ? num + SpecifPow - RoundedPart : num - RoundedPart;
...
function toNumber(value, def) {
    let ResultValue = Number.parseInt(value);
